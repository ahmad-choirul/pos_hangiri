	...
	<div class="container">
		<div class="row">
			...
			<div class="col-lg-10">
				...
				<div class="main-menu">
					<ul>
						<li class="active"><a href="babe-q.com">home</a></li>
    			...
    			<div class="row">
    				...
    				<div class="col-md-6 align-self-center">
    					<div class="welcome-text mt-5 mt-md-0">
    						...
    						<p class="pt-3">Restoran yang menyajikan aneka menu grill dan budae jigae yang merupakan perpaduan rasa yang ada di Asia. Rasa yang dapat memanjakan lidah anda. Stay safe and healthy babe 😍.</p>
    			...
    			<div class="row">
    				...
    				<div class="col-md-4">
    					<div class="single-widget single-widget2 my-5 my-md-0">
    						...
    						<div class="d-flex">
    							...
    							<div class="info-text">
    								<a href="https://instagram.com/babeq.official/">@babeq.official</a>
    							</div>
    						</div>
    					</div>
    				</div>
    				<div class="col-md-4">
    					<div class="single-widget single-widget3">
    						...
    						<p>Sunday - Monday ...... 10 am - 10 pm</p>
    						<p>Holidays ............. 10 am - 10 pm</p>
    					</div>
    				</div>
    			</div>
    		</div>

  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <section class="panel  panel-primary">
        <?php echo form_open('penjualan/promositambah',' id="FormulirTambah"');?>  
        <header class="panel-heading">
          <h2 class="panel-title">Tambah Promosi</h2>
        </header>
        <div class="panel-body">
          ...
          <div class="form-group mt-lg instagram">
            <label class="col-sm-3 control-label">Instagram<span class="required">*</span></label>
            <div class="col-sm-9">
          ...
          <div class="form-group mt-lg tanggal_lahir">
            ...
            <div class="col-sm-9">
              <input type="text" name="tanggal_lahir" class="form-control tanggal" required/>
            </div>
          </div> 
          ...
          <div class="form-group mt-lg hp">
            <label class="col-sm-3 control-label">Master Promosi<span class="required">*</span></label>
            <div class="col-sm-9">
            <select data-plugin-selectTwo class="form-control" name="id_promosi" required>  
              <?php foreach ($id_promosi as $supp): ?>
                <option value="<?php echo $supp->id_promosi;?>"><?php echo $supp->nama_promosi;?></option>
              <?php endforeach; ?>
            </select> 
          </div>
          </div> 
...
<div class="modal fade" id="editData" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <section class="panel  panel-primary">
        <?php echo form_open('penjualan/promosiedit',' id="FormulirEdit"');?>  
        ...
        <div class="panel-body">
          <div class="form-group mt-lg nama">
            <label class="col-sm-3 control-label">Kode Promosi<span class="required">*</span></label>
            <div class="col-sm-9">
              <input type="text" readonly id="kode_promosi" name="kode_promosi" class="form-control" required/>
            </div>
          </div> 
          <div class="form-group mt-lg nama">
            <label class="col-sm-3 control-label">Nama<span class="required">*</span></label>
          ...
          <div class="form-group mt-lg tanggal_lahir">
            <label class="col-sm-3 control-label">Tanggal Lahir<span class="required">*</span></label>
            <div class="col-sm-9">
              <input type="text" id="tanggal_lahir"  name="tanggal_lahir" class="form-control tanggal" required/>
            </div>
          </div> 
          <div class="form-group mt-lg hp">
            <label class="col-sm-3 control-label">HP<span class="required">*</span></label>
           ...
           <div class="form-group mt-lg hp">
            ...
            <select data-plugin-selectTwo class="form-control" name="id_promosi" id="id_promosi" required>  
              <?php foreach ($id_promosi as $supp): ?>
                <option value="<?php echo $supp->id_promosi;?>"><?php echo $supp->nama_promosi;?></option>
              <?php endforeach; ?>
            </select> 
    ...
    <div class="modal-content">
      <section class="panel  panel-danger">
        ...
        <footer class="panel-footer"> 
          <div class="row">
            <div class="col-md-12 text-right"> 
              <?php echo form_open('penjualan/promosihapus',' id="FormulirHapus"');?>  
...
<script type="text/javascript"> 
  ...
  var tablepromosi = $('#promosidata').DataTable({  
    ...
    "order": [], 
    "ajax": {
      "url": "<?php echo base_url()?>penjualan/data_kode_promosi",
      "type": "GET"
    }, 
    "columnDefs": [
    { 
  ...
  function edit(elem){
    ...
    $.ajax({
      type: 'GET',
      url: '<?php echo base_url()?>penjualan/promosidetail',
      data: 'id=' + dataId,
      dataType 	: 'json',
      success: function(response) {  
        $.each(response, function(i, item) { 
          document.getElementById("kode_promosi").setAttribute('value', item.kode_promosi); 
          document.getElementById("nama").setAttribute('value', item.nama); 
          document.getElementById("instagram").setAttribute('value', item.instagram); 
          document.getElementById("hp").setAttribute('value', item.hp); 
          document.getElementById("tanggal_lahir").setAttribute('value', item.tanggal_lahir); 

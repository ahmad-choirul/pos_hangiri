	...
	<body class="bgbody">
            ...
            <div class="modal-dialog">
                ...
                <section class="panel panel-primary">
                    ...
                    <div class="panel-body">
                            ...
                            <div class="form-group mt-lg nama_pembeli">
                                <label class="col-sm-3 control-label">Kontak Pembeli<span class="required">*</span></label>
                                <div class="col-sm-9">
        ...
        <div class="modal fade" id="detailData" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                ...
                <section class="panel  panel-primary">   
                    <header class="panel-heading">
                        <h2 class="panel-title">Detail Pembeli</h2>
                    </header>
                ...
                $.ajax({
                    ...
                    success: function(response) { 
                        ...
                        $.each(response, function(i, item) {
                            ...
                            datarow+="<tr><td>Kontak Pembeli</td><td>: "+item.hp+"</td></tr>";
                            datarow+="</table>";
                        });

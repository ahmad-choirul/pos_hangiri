										...
										<div class="inner-menu-content">  
											...
											<div class="sidebar-widget m-none"> 
												<div class="widget-content">
                                                    ...
                                                    <?php if( $this->session->userdata('kategori')==31){?>
														<li>
															<a href="<?php echo base_url()?>master/supplier" class="menu-item" style="color: white"><i class="fa fa-folder"></i> Master Supplier</a>
															<div class="item-options">
                                                    ...
                                                    <?php if( $this->session->userdata('kategori')==31){?>
														<li>
															<a href="<?php echo base_url()?>master/itemkategori" class="menu-item" style="color: white"><i class="fa fa-folder"></i> Master Kategori Item</a>
															<div class="item-options">
                                                    ...
                                                    <?php if( $this->session->userdata('kategori')==31){?>
														<li>
															<a href="<?php echo base_url()?>master/pegawai" class="menu-item" style="color: white"><i class="fa fa-folder"></i> Master Pegawai</a>
															<div class="item-options">

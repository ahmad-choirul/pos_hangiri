...
<body class="bgbody">
  <section class="body">
   ...
   <div class="inner-wrapper">
    ...
    <!-- start: page -->
    <form method="post" action="<?php site_url('master/operasionalpdf') ?>">
      <section class="panel"> 
    ...
    <section class="panel">
      <header class="panel-heading">
        <div class="row show-grid">
          <div class="col-md-6" align="left"><h2 class="panel-title">Data Biaya Operasional Babe-Q</h2></div>
          <?php
    ...
    <section class="panel">
      <header class="panel-heading">
        <div class="row show-grid">
          <div class="col-md-6" align="left"><h2 class="panel-title">Data Biaya Operasional Hangiri</h2></div>
          <?php
          echo level_user('master','operasional',$this->session->userdata('kategori'),'add') > 0 ? '<div class="col-md-6" align="right"><a class="btn btn-success" href="#"  data-toggle="modal" data-target="#tambahData"><i class="fa fa-plus"></i> Tambah</a></div>':'';
          ?>
        </div>
...
<script type="text/javascript">
  ...
  var tablepembeli = $('#pembelidata').DataTable({
    ...
    "order": [],
    "ajax": {
      "url": "<?php echo base_url()?>master/dataoperasional/babe-q",
      "type": "GET",
      "data": function ( data ) {
  ...
  var tablepembeli2 = $('#pembelidata2').DataTable({
    ...
    "order": [],
    "ajax": {
      "url": "<?php echo base_url()?>master/dataoperasional/hangiri",
      "type": "GET",
      "data": function ( data ) {
        var firstdate = $('#firstdate').val();
        var lastdate = $('#lastdate').val();
    ...
    $.ajax({
      ...
      success: function(response) {
        ...
        $.each(response, function(i, item) {
          ...
          datarow+="<tr><td>Resto</td><td>: "+item.resto+"</td></tr>";
          datarow+="</table>";
        });
